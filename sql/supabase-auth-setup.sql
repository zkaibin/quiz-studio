...
-- 5) Storage bucket for uploaded profile pictures
...
create policy "profile_pictures_upload_own"
on storage.objects
for insert
to authenticated
with check (
...
-- 6) Optional convenience trigger to auto-create profile at signup
